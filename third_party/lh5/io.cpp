...
// MODIFIED from upstream: throws instead of exit()'ing the whole process.
// Upstream was a CLI archiver where a fatal decode error should kill the
// program; here it's one path inside a GUI app, so a malformed/corrupt
// import file must fail the import, not crash the editor.
